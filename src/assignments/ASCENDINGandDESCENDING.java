...
public class ASCENDINGandDESCENDING {
    public static void main(String[] args){
       ...
       String temp2= JOptionPane.showInputDialog(null,"enter first number");
       entry2= Integer.parseInt(temp2);
       String temp3= JOptionPane.showInputDialog(null,"enter first number");
       ...
       if (entry1 > entry2 && entry1 >entry3) {
           ...
           else if(entry3 > entry1 && entry2 >entry3){
       }
